    ...
    <div className="max-w-4xl mx-auto pb-20">
      ...
      {showAudioPlayer && (
        <div className="mb-6 animate-in slide-in-from-top-3 duration-300">
          <AudioBriefingPlayer
            ...
            duration={article.audioDuration || '3m 15s'}
          />
        </div>
      )}
      ...
      <header className="space-y-4 mb-8">
        <div className="flex flex-wrap items-center gap-3">
          <span className={`px-3 py-1 rounded-full text-xs font-mono border ${categoryStyle.color}`}>
            {categoryStyle.label}
          </span>
            ...
            <div>
              <div className="text-zinc-200 font-bold flex items-center gap-1.5">
                ...
                {article.author.verified && (
                  <span title="Verified Staff Researcher">
